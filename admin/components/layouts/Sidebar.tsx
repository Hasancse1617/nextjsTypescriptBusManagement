        ...
        <>
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="/admin/dashboard" className="brand-link">
                    <img src="/images/admin_images/AdminLTELogo.png"
                        alt="AdminLTE Logo"
                ...
                <nav className="mt-2">
                    ...
                    <li className="nav-item has-treeview">
                        <Link href="/admin/dashboard">
                            <a className={pathname == "/admin/dashboard" ? "nav-link active" : "nav-link"}>
                    ...
                    <li className="nav-item has-treeview menu-open">
                        ...
                        <ul className="nav nav-treeview">
                            <li className="nav-item">
                                <Link href="/admin/user/all?page=1">
                                    <a className={pathname==='/admin/user/all'?'active nav-link':'nav-link'}>
